...
| M02-14 | [Nomes, arquivos e conteúdo](../book/modulo-2/capitulo-10/10.1-arquivos-nomes-e-leitura.md) | Hard links, descritores, metadados e leitura; exemplo temporário próprio. | Fundamentos, DRAFT; [fontes S1–S18](../book/modulo-2/capitulo-10/referencias.md). Sem recuperação forense ou leitura de arquivos pessoais. |
